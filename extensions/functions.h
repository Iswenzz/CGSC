...
/// @brief Alloc a new GSC float param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define FLOAT(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_FLOAT)

/// @brief Alloc a new GSC int param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define INT(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_INTEGER)

/// @brief Alloc a new GSC vector param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define VECTOR(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_VECTOR)

/// @brief Alloc a new GSC pointer param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define POINTER(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_POINTER)

/// @brief Alloc a new GSC string param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define STRING(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_STRING)

/// @brief Alloc a new GSC localized string param before calling the function
/// with Scr_CallFunction/Scr_CallMethod.
#define ISTRING(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_ISTRING)

/// @brief Alloc a new GSC function param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define FUNC(val) Scr_SetParamGeneric(__callArgNumber, val, VAR_FUNCTION)

/// @brief Alloc a new GSC undefined param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
#define UNDEFINED() Scr_SetParamGeneric(__callArgNumber, NULL, VAR_UNDEFINED)

/// @brief Alloc a new GSC generic param before calling the function with
/// Scr_CallFunction/Scr_CallMethod.
...
/// @brief Call the specified GSC function pointer. This function is
/// experimental.
...
/// @brief Call the specified GSC method pointer. This function is experimental.
